...
public class RegistrationApiApplication {
    ...
    public void run() {
        ...
        Address address5 = new Address(null, "Teste2", "2762323", 123, "Teste", true, person2);
        Address address6 = new Address(null, "Teste2", "2762323", 123, "Teste", true, person2);
        Address address7 = new Address(null, "Teste2", "2762323", 123, "Teste", true, person2);
        Address address8 = new Address(null, "Teste2", "2762323", 123, "Teste", true, person2);
